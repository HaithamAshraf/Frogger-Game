...
void level3(int,int,string);
using namespace std;
using namespace sf;
void level2(int lvl1score,int lvl1losecount, string name) {
	string Name = name;
	...
	int i = 0, losecount = lvl1losecount, score = lvl1score, pixelcountUP = 0, pixelcountDOWN = 0, winner = 0;;
